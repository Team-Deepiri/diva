...
| `nd_class` / `nd_trait` / `nd_impl` | yes | partial | partial | Field-only class/struct + obj lit; not trait/impl/methods |
...
| `nd_generic_call` | yes | yes | yes | Type erasure (see `docs/generics-specialization.md`) |
